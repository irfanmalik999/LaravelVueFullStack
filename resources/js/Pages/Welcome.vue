...
<template v-else>
    ...
    <div class="flex justify-center items-center space-x-4 mt-80 ">
        <Link
        ...
        <Link
            :href="route('login')"
            class="font-semibold text-2xl bg-green-600 hover:bg-green-700 px-5 py-2 text-white  dark:text-white dark:hover:text-pink-100 focus:outline focus:outline-2 rounded-lg focus:rounded-sm focus:outline-red-500"
        >Log in</Link>

        <Link
            v-if="canRegister"
            :href="route('register')"
            class="font-semibold text-2xl bg-blue-600 hover:bg-blue-800 px-5 py-2 text-white  dark:text-white dark:hover:text-pink-100 focus:outline focus:outline-2 rounded-lg focus:rounded-sm focus:outline-red-500"
        >Register</Link>
    </div>
